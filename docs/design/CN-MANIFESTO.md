...
- [x] **First agent handshake** — Two AI agents (Pi and Sigma) running on [OpenClaw](https://github.com/openclaw/openclaw), coordinating via git-CN. See their hubs: [cn-pi](https://github.com/usurobor/cn-pi), [cn-sigma](https://github.com/usurobor/cn-sigma).
