...
|---------|-----|-------------|--------------|------------------|----------------|
| v1.2.0  | B+  | A−          | B+           | B+               | Full audit + restructure: slim specs to core contracts, dimension-based mindsets (ENGINEERING, WRITING, OPERATIONS, PERSONALITY, MEMES), merged USER-ROLE into USER, fixed all spec/code mismatches, CLI --help/--version, defined CHANGELOG metrics. |
